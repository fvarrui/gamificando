...
(function (global) {
  ...
  UW.MISSION_CONTENT = [
    /* ---------------- FASE 1 · QUIÉN HAY ---------------- */
    {
      ...
      hints: [
        "Estás en C:\\Users\\hamilton y el archivo está ahí mismo.",
    ...
    },
    {
      ...
      text: "Carrie-Anne Moss entra en el equipo comercial. Crea su cuenta con su nombre completo y su descripción.",
      objective: "Crea la cuenta local moss, sin contraseña inicial, con la descripción «Ventas».",
      hints: [
        ...
        "Escribe: New-LocalUser -Name moss -NoPassword -Description \"Ventas\""
      ]
    },
    {
      ...
      objective: "Muestra la ficha de la cuenta moss.",
      hints: [
        ...
        "Escribe: Get-LocalUser moss"
      ]
    },
    {
      phase: 1, severity: "info", source: RRHH, xp: 150,
      title: "Alta de Jackie",
      text: "Jackie Chan entra en proyectos. Crea su cuenta igual que la anterior.",
      objective: "Crea la cuenta local chan, sin contraseña inicial, con la descripción «Proyectos».",
      hints: [
        "Misma orden que con Carrie-Anne, cambiando el nombre y la descripción.",
        "A diferencia de Linux, aquí la cuenta ya nace con su perfil pendiente de crearse en el primer inicio de sesión.",
        "Escribe: New-LocalUser -Name chan -NoPassword -Description \"Proyectos\""
      ]
    },
    {
      ...
      objective: "Añade a chan al grupo local Proyectos.",
      hints: [
        ...
        "Escribe: Add-LocalGroupMember -Group Proyectos -Member chan"
      ]
    },
    ...
    /* ---------------- FASE 3 · PERTENENCIAS ---------------- */
    {
      ...
      title: "Carrie-Anne, al equipo comercial",
      text: "Lo mismo para Carrie-Anne: su carpeta departamental cuelga de los permisos del grupo Ventas.",
      objective: "Añade a moss al grupo local Ventas.",
      hints: [
        ...
        "Escribe: Add-LocalGroupMember -Group Ventas -Member moss"
      ]
    },
    {
      ...
      hints: [
        ...
        "Deben aparecer lundgren y moss.",
    ...
    },
    {
      ...
      text: "Jackie se apunta al plan de formación de este trimestre.",
      objective: "Añade a chan al grupo local Formacion.",
      hints: [
        "Mismo cmdlet, cambiando el grupo.",
        "Una persona puede estar en tantos grupos como haga falta: los permisos se suman.",
        "Escribe: Add-LocalGroupMember -Group Formacion -Member chan"
      ]
    },
    {
      phase: 2, severity: "info", source: YEOH, xp: 150,
      title: "Jean-Claude sale del proyecto",
      text: "Jean-Claude deja de participar en el proyecto Atlante antes incluso de su baja. Sácalo del grupo, pero no toques su cuenta todavía.",
      objective: "Quita a vandamme del grupo local Proyectos.",
      hints: [
        "El verbo para quitar es Remove: Remove-LocalGroupMember.",
        "Usa los mismos parámetros: -Group y -Member.",
        "Escribe: Remove-LocalGroupMember -Group Proyectos -Member vandamme"
      ]
    },
    {
      phase: 2, severity: "info", source: YEOH, xp: 100,
    ...
    /* ---------------- FASE 4 · BAJAS ---------------- */
    {
      ...
      title: "La ficha de Jean-Claude",
      text: "Jean-Claude se va el viernes. Antes de decidir nada, mira el estado de su cuenta.",
      objective: "Muestra la ficha de la cuenta vandamme.",
      hints: [
        "Get-LocalUser con el nombre de la cuenta.",
        "Fíjate en la columna Enabled: ahora mismo está en True.",
        "Escribe: Get-LocalUser vandamme"
      ]
    },
    {
    ...
    },
    {
      ...
      objective: "Muestra otra vez la ficha de la cuenta vandamme y comprueba que está deshabilitada.",
      hints: [
    ...
    },
    {
      ...
      title: "Corrige la ficha de Carrie-Anne",
      text: "Personas y Talento avisa: la descripción de Carrie-Anne tiene que incluir su sede, que trabaja desde Las Palmas.",
      objective: "Cambia la descripción de la cuenta moss a «Ventas · Las Palmas».",
      hints: [
        "El verbo para modificar es Set: Set-LocalUser.",
        "Usa -Name para indicar la cuenta y -Description para el texto nuevo.",
        "Escribe: Set-LocalUser -Name moss -Description \"Ventas · Las Palmas\""
      ]
    },
    {
    ...
    },
    {
      ...
      objective: "Guarda en C:\\Users\\hamilton\\cuentas.txt el listado de cuentas con su nombre y su estado.",
      hints: [
