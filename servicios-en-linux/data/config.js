...
(function (global) {
  ...
  SL.cfg = {
    ...
    BASE_PROCESSES: [
      ...
      { user: "ana", pid: 3120, cmd: "-bash", name: "bash" }
    ]
  };
  ...
  SL.build = function (S) {
    S.sys.load({
      ...
      users: [
        ...
        { name: "ana", uid: 1100, group: "ana", home: "/home/ana", comment: "Ana Betancor · Guardia" },
        { name: "www-data", uid: 33, group: "www-data", home: "/var/www", shell: "/usr/sbin/nologin", system: true }
      ],
      members: [["sudo", "ana"], ["sistemas", "ana"]],
      services: [
        {
          ...
          log: [
            ...
            "oct 14 03:10:41 srv-web sshd[812]: Accepted publickey for ana from 192.168.10.5"
          ]
        },
        {
