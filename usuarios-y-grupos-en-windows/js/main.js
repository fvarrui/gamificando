...
(function (global) {
  ...
  UW.S = RG.Sandbox({
    ...
    boot: [
      ...
      [400, "text", "SRV-OFICINA · ana · equipo fuera de dominio: todas las cuentas son locales"],
      [800, "text", ""],
      [900, "ok", "Semana de altas y bajas. El parte está en C:\\Users\\ana\\altas.txt."]
    ],

    badgesOf: function (S, got) {
      var dario = S.sys.user("dario");
      got.soft = !!dario && !dario.enabled;
    ...
    debriefText: function (S, got, doneCount) {
      ...
      if (got.clean && got.self) {
        ...
        t.msg = "La semana queda cerrada: Elena y Hugo tienen cuenta y grupo, Darío está deshabilitado, la cuenta del curso de 2023 ha desaparecido " +
