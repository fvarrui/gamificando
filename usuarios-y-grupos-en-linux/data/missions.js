...
(function (global) {
  ...
  UG.MISSION_CONTENT = [
    /* ---------------- FASE 1 · QUIÉN HAY ---------------- */
    {
      ...
      hints: [
        "Estás en /home/ana y el fichero está ahí mismo.",
    ...
    {
      phase: 0, severity: "info", source: CARLA, xp: 100,
      title: "La ficha de Carla",
      text: "Carla pregunta en qué grupos está, porque no puede escribir en una carpeta compartida. Compruébalo.",
      objective: "Muestra el identificador y los grupos del usuario carla.",
      hints: [
        "La orden id acepta un nombre de usuario: id USUARIO.",
        "También puedes usar groups carla, que muestra solo los nombres.",
        "Escribe: id carla"
      ]
    },
    {
      phase: 0, severity: "warn", source: NAYRA, xp: 100,
    ...
    },
    {
      ...
      title: "Alta de Elena",
      text: "Elena Quintana entra en el equipo comercial. Necesita cuenta, directorio personal y un intérprete de órdenes normal, porque va a trabajar por consola.",
      objective: "Crea la cuenta elena con directorio personal, shell /bin/bash y el comentario «Elena Quintana».",
      hints: [
        ...
        "Escribe: sudo useradd -m -s /bin/bash -c \"Elena Quintana\" elena"
      ]
    },
    {
      ...
      objective: "Lista en formato largo el contenido de /home para ver el directorio personal de elena.",
      hints: [
    ...
    },
    {
      ...
      objective: "Establece la contraseña de la cuenta elena.",
      hints: [
        "La orden es passwd seguida del nombre de usuario.",
        "Cambiar la contraseña de otra persona requiere privilegios: usa sudo.",
        "Escribe: sudo passwd elena"
      ]
    },
    {
      phase: 1, severity: "info", source: RRHH, xp: 150,
      title: "Alta de Hugo, ya en su equipo",
      text: "Hugo Santana entra en proyectos. Esta vez hazlo de una sola vez: cuenta, carpeta, comentario y grupo secundario en la misma orden.",
      objective: "Crea la cuenta hugo con directorio personal, comentario «Hugo Santana» y el grupo secundario proyectos.",
      hints: [
        ...
        "Escribe: sudo useradd -m -c \"Hugo Santana\" -G proyectos hugo"
      ]
    },
    ...
    /* ---------------- FASE 3 · PERTENENCIAS ---------------- */
    {
      ...
      title: "Elena entra en ventas",
      text: "Se nos pasó: Elena necesita estar en el grupo ventas. Mucho cuidado aquí, porque hay una forma de hacerlo que le quitaría todos los demás grupos.",
      objective: "Añade a elena al grupo secundario ventas sin sacarla de ningún otro.",
      hints: [
        ...
        "Escribe: sudo usermod -aG ventas elena"
      ]
    },
    {
      ...
      objective: "Muestra los grupos de elena.",
      hints: [
        "id elena muestra el uid, el gid y todos sus grupos.",
        "También sirve groups elena.",
        "Escribe: id elena"
      ]
    },
    {
      ...
      text: "Hugo se apunta al plan de formación. Para mover gente entre grupos existe una orden más directa que usermod.",
      objective: "Añade a hugo al grupo formacion usando gpasswd.",
      hints: [
        ...
        "Escribe: sudo gpasswd -a hugo formacion"
      ]
    },
    {
      phase: 2, severity: "info", source: CARLA, xp: 125,
      title: "Darío sale del proyecto",
      text: "Darío deja de participar en el proyecto Atlante esta semana, antes incluso de su baja. Sácalo del grupo.",
      objective: "Quita a dario del grupo proyectos.",
      hints: [
        "La opción de gpasswd para quitar a alguien es -d.",
        "Se escribe igual que para añadir: gpasswd -d USUARIO GRUPO.",
        "Escribe: sudo gpasswd -d dario proyectos"
      ]
    },
    {
      phase: 2, severity: "info", source: CARLA, xp: 125,
    ...
    /* ---------------- FASE 4 · BAJAS Y BLOQUEOS ---------------- */
    {
      ...
      title: "El estado de la cuenta de Darío",
      text: "Darío se va el viernes. Antes de decidir nada, mira en qué estado está su cuenta.",
      objective: "Consulta el estado de la cuenta dario.",
      hints: [
    ...
    },
    {
      ...
      objective: "Bloquea la cuenta de dario para que no pueda iniciar sesión.",
      hints: [
        "usermod tiene la opción -L (lock) para bloquear una cuenta, y -U para desbloquearla.",
        "También vale passwd -l dario. Lo importante es que la cuenta siga existiendo.",
        "Escribe: sudo usermod -L dario"
      ]
    },
    {
      ...
      objective: "Consulta otra vez el estado de la cuenta dario y comprueba que aparece como L.",
      hints: [
    ...
    },
    {
      ...
      hints: [
        "Es el mismo listado que hiciste al dar de alta a Elena.",
        "Compara: ahora deben estar elena y hugo, y no debe estar visitas.",
        "Escribe: ls -l /home"
      ]
    },
    ...
    {
      phase: 4, severity: "warn", source: NAYRA, xp: 150,
      title: "Y remata la baja",
      text: "A la cuenta bloqueada de Darío le falta un detalle: aunque no pueda autenticarse con contraseña, conviene quitarle también el intérprete de órdenes.",
      objective: "Cambia el intérprete de la cuenta dario a /usr/sbin/nologin.",
      hints: [
        ...
        "Escribe: sudo usermod -s /usr/sbin/nologin dario"
      ]
    },
    {
      ...
      hints: [
        ...
        "Debe aparecer hugo entre sus miembros.",
