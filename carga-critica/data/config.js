...
(function (global) {
  ...
  DK.cfg = {
    ...
    BASE_PROCESSES: [
      ...
      { user: "hamilton", pid: 2401, cmd: "-bash", name: "bash" }
    ]
  };
  ...
  DK.build = function (S) {
    S.sys.load({
      ...
      members: [["sudo", "hamilton"], ["docker", "hamilton"]]
    });
    ...
    S.vfs.build({
      ...
      "/home/hamilton/intranet": { dir: true, owner: "hamilton", group: "hamilton", mtime: D },
      "/home/hamilton/intranet/Dockerfile": {
        owner: "hamilton", group: "hamilton", mtime: D,
        content: [
      ...
      "/home/hamilton/intranet/index.html": {
        owner: "hamilton", group: "hamilton", mtime: D,
        content: [
          "<!DOCTYPE html>",
          "<html lang=\"es\">",
      ...
      "/home/hamilton/pila": { dir: true, owner: "hamilton", group: "hamilton", mtime: D },
      "/home/hamilton/pila/compose.yaml": {
        owner: "hamilton", group: "hamilton", mtime: D,
        content: [
          "services:",
          "  web:",
