...
(function (global) {
  ...
  PL.MISSION_CONTENT = [
    ...
    {
      phase: 0, severity: "high", source: NAYRA, xp: 125,
      title: "Lo más grave",
    ...
    },
    {
      ...
      title: "Y su responsable, Carla",
      text: "Carla coordina el proyecto Atlante: que los documentos sean suyos, no de root. Así podrá ajustar permisos sin pedírnoslo cada vez.",
      objective: "Haz que carla sea la propietaria de memoria.txt, presupuesto.csv y acta-direccion.txt.",
      hints: [
        ...
        "Escribe: sudo chown carla memoria.txt presupuesto.csv acta-direccion.txt"
      ]
    },
    {
      phase: 1, severity: "warn", source: CARLA, xp: 175,
      title: "El problema de los ficheros nuevos",
      text: "Carla avisa: «cuando creo un fichero aquí, se queda con MI grupo, no con el del proyecto, y mis compañeros no pueden tocarlo». Hay un bit pensado exactamente para eso.",
    ...
    /* ---------------- FASE 3 · CHMOD ---------------- */
    {
      phase: 2, severity: "high", source: NAYRA, xp: 125,
    ...
    /* ---------------- FASE 4 · ACL ---------------- */
    {
      ...
      text: "Dirección pregunta: Bruno, de ventas, necesita LEER el presupuesto. Pero Bruno no está en proyectos, y no vamos a meterlo: solo necesita ese fichero.",
    ...
    {
      phase: 3, severity: "warn", source: DIR, xp: 175,
      title: "Darío solo necesita el acta",
      text: "Darío está de prácticas en dirección. Necesita leer el acta y nada más: ni el presupuesto, ni la memoria, ni la carpeta privada.",
      objective: "Concede al usuario dario permiso de solo lectura sobre acta-direccion.txt.",
      hints: [
        ...
        "Escribe: sudo setfacl -m u:dario:r acta-direccion.txt"
      ]
    },
    {
      phase: 3, severity: "warn", source: NAYRA, xp: 175,
      title: "Darío también necesita entrar",
      ...
      objective: "Concede al usuario dario permiso de ejecución (atravesar) sobre la carpeta /srv/proyectos, sin darle lectura del listado.",
      hints: [
        "En un directorio, x significa «puedo atravesarlo si sé el nombre exacto» y r significa «puedo listar su contenido».",
        "Como solo tiene que llegar al acta, con x basta: u:dario:x",
        "Escribe: sudo setfacl -m u:dario:x /srv/proyectos"
      ]
    },
    {
      phase: 3, severity: "high", source: NAYRA, xp: 175,
      title: "Se acabó el contrato",
      text: "La consultora que instaló el servidor ya no trabaja con nosotros: el usuario bruno tenía una ACL de prueba sobre la memoria del proyecto y hay que retirarla.",
      objective: "Elimina la entrada ACL del usuario bruno en memoria.txt.",
      hints: [
        "La opción de setfacl para eliminar una entrada concreta es -x.",
        "Se indica el tipo y el nombre, sin permisos: -x u:bruno",
        "Escribe: sudo setfacl -x u:bruno memoria.txt"
      ]
    },

    /* ---------------- FASE 5 · FICHEROS NUEVOS ---------------- */
    {
      phase: 4, severity: "warn", source: CARLA, xp: 175,
    ...
    {
      phase: 4, severity: "info", source: CARLA, xp: 150,
