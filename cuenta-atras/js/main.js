...
(function (global) {
  ...
  UG.S = RG.Sandbox({
    ...
    boot: [
      ...
      [400, "text", "hamilton@srv-datos · miembro de sudo, sistemas y direccion"],
      [800, "text", ""],
    ...
    badgesOf: function (S, got) {
      ...
      got.soft = !!vandamme && !!vandamme.locked;
    },
    ...
    debriefText: function (S, got, doneCount) {
      ...
      if (got.clean && got.self) {
        ...
        t.msg = "La semana queda cerrada: Carrie-Anne y Jackie tienen cuenta y grupos, la cuenta compartida ha desaparecido, la baja está bloqueada " +
