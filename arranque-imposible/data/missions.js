...
(function (global) {
  ...
  SW.MISSION_CONTENT = [
    ...
    {
      phase: 1, severity: "high", source: WEAVER, xp: 175,
      title: "Habilítalo",
    ...
    {
      phase: 2, severity: "warn", source: WEAVER, xp: 150,
    ...
    },
    {
      ...
      objective: "Guarda en C:\\Users\\hamilton\\estado-final.txt el listado de servicios con su nombre, estado y tipo de inicio.",
      hints: [
