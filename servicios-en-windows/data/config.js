  ...
  SW.build = function (S) {
    S.sys.load({
      ...
      users: [
        ...
        { name: "ana", uid: 1000, group: "Usuarios", home: "C:\\Users\\ana", comment: "Ana Betancor · Guardia" }
      ],
      members: [["Administradores", "ana"], ["Usuarios", "ana"], ["Sistemas", "ana"]],
      services: [
        {
        ...
        },
        {
          ...
          log: ["20/10/2026 07:38  Sesión iniciada por ana desde 192.168.10.5"]
        }
      ]
    });
