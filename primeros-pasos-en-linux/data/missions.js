...
(function (global) {
  ...
  var IKER = "Iker Alonso · Soporte";

  LX.MISSION_CONTENT = [
    /* ---------------- FASE 1 · ORIENTACIÓN ---------------- */
    {
      phase: 0, severity: "info", source: NAYRA, xp: 50,
      title: "¿Dónde estás?",
    ...
    {
      phase: 0, severity: "info", source: IKER, xp: 100,
    ...
    {
      phase: 1, severity: "info", source: NAYRA, xp: 75,
    ...
    {
      phase: 1, severity: "warn", source: IKER, xp: 100,
    ...
    {
      phase: 1, severity: "warn", source: IKER, xp: 125,
    ...
    {
      phase: 2, severity: "info", source: IKER, xp: 125,
    ...
    {
      phase: 2, severity: "info", source: IKER, xp: 100,
    ...
    {
      phase: 3, severity: "info", source: IKER, xp: 125,
      title: "¿Dónde está ese fichero?",
      text: "Nayra pregunta por «notas.md» y nadie recuerda en qué carpeta quedó. Con el árbol lleno de subcarpetas, buscar a mano es perder la mañana.",
    ...
    {
      phase: 3, severity: "warn", source: IKER, xp: 150,
    ...
    {
      phase: 4, severity: "info", source: NAYRA, xp: 100,
      title: "¿Quién eres aquí?",
      text: "En un servidor compartido, saber con qué cuenta estás trabajando evita muchos disgustos: no es lo mismo tocar algo como practicas que como root.",
    ...
    {
      phase: 4, severity: "info", source: IKER, xp: 125,
