...
(function (global) {
  ...
  var IKER = "Iker Alonso · Sistemas";
  var NAYRA = "Nayra Suárez · Soporte";

  PS.MISSION_CONTENT = [
    /* ---------------- FASE 1 · ORIENTACIÓN ---------------- */
    {
      phase: 0, severity: "info", source: IKER, xp: 50,
      title: "¿Dónde estás?",
    ...
    {
      phase: 0, severity: "info", source: IKER, xp: 75,
    ...
    },
    {
      ...
      hints: [
        ...
        "Su alias es cd, y admite rutas relativas: no hace falta escribir C:\\Users\\practicas\\Documentos.",
    ...
    {
      phase: 1, severity: "info", source: IKER, xp: 75,
    ...
    {
      phase: 1, severity: "info", source: IKER, xp: 100,
    ...
    {
      phase: 1, severity: "warn", source: NAYRA, xp: 100,
    ...
    {
      phase: 2, severity: "warn", source: IKER, xp: 100,
    ...
    {
      phase: 3, severity: "info", source: IKER, xp: 150,
    ...
    {
      phase: 4, severity: "info", source: IKER, xp: 100,
