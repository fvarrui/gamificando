...
*Versionando con Git* es un juego educativo que se ejecuta en el navegador. El alumnado
...
provocan los compañeros de equipo: Iker (en prácticas) rompe cosas y Nayra sube trabajo al
...
- **En el aula virtual (EVAGD/Moodle)**: subir la carpeta completa del reto **junto con la
  ...
  `versionando-con-git/index.html`. El reto usa CSS y scripts clásicos, sin módulos ES ni
...
| # | Ticket | Misión | Qué se practica |
|---|--------|--------|-----------------|
| 11 | GIT-11 | ¡Iker ha roto servicios.conf! | `git restore <fichero>` |
...
| | *Blindaje de la Red* | *Versionando con Git* |
|---|---|---|
...
| Personajes | El SOC | Iker y Nayra, que trabajan (y meten la pata) en tu repositorio |
...
| `js/missions.js` | Comprobaciones de cada misión, lo que hacen Iker y Nayra, y la solución de cada ticket |
