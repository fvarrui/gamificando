...
(function (global) {
  ...
  VG.cfg = {
    ...
    REPO_DIR: "/home/blueteam/scripts-blindaje",
    REMOTE_URLS: [
    ...
    TZ_NAME: "WEST",
    IKER: { name: "Iker Alonso", email: "iker.alonso@tecnoatlantica.local" },
    NAYRA: { name: "Nayra Suárez", email: "nayra.suarez@tecnoatlantica.local" }
  };
