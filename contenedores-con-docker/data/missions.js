...
(function (global) {
  ...
  var CARLA = "Carla Ojeda · Desarrollo";
  ...
  DK.MISSION_CONTENT = [
    ...
    {
      phase: 0, severity: "high", source: NAYRA, xp: 150,
    ...
    {
      phase: 1, severity: "info", source: NAYRA, xp: 125,
    ...
    /* ---------------- FASE 3 · DATOS ---------------- */
    {
      phase: 2, severity: "warn", source: CARLA, xp: 125,
    ...
    {
      phase: 2, severity: "warn", source: CARLA, xp: 150,
    ...
    {
      phase: 2, severity: "high", source: NAYRA, xp: 200,
    ...
    {
      phase: 3, severity: "info", source: CARLA, xp: 125,
    ...
    {
      phase: 3, severity: "high", source: CARLA, xp: 175,
    ...
    {
      phase: 3, severity: "info", source: CARLA, xp: 100,
    ...
    {
      phase: 3, severity: "warn", source: NAYRA, xp: 150,
    ...
    {
      phase: 4, severity: "high", source: NAYRA, xp: 200,
