...
(function (global) {
  ...
  LX.cfg = {
    ...
    HOME: "/home/hamilton",
    CWD: "/home/hamilton",
    TEAM: "Sigourney Weaver (administradora de sistemas)",
    TERM_TITLE: "bash",
    TZ_NAME: "WEST",
    UMASK: 0o022,
    ...
    BASE_PROCESSES: [
      ...
      { user: "hamilton", pid: 1841, cmd: "-bash", name: "bash" }
    ]
  };
  ...
  LX.build = function (S) {
    S.sys.load({
      groups: [
        ...
        { name: "hamilton", gid: 1001 },
        { name: "novatos", gid: 1002, description: "Últimas incorporaciones" }
      ],
      users: [
        { name: "root", uid: 0, group: "root", home: "/root", shell: "/bin/bash", system: true },
        { name: "weaver", uid: 1000, group: "sistemas", home: "/home/weaver", comment: "Sigourney Weaver" },
        { name: "hamilton", uid: 1001, group: "hamilton", home: "/home/hamilton", comment: "Linda Hamilton · Nueva incorporación" }
      ],
      members: [["novatos", "hamilton"], ["sistemas", "weaver"]]
    });

    S.vfs.build({
      "/home": { dir: true, owner: "root", group: "root" },
      "/home/weaver": { dir: true, owner: "weaver", group: "sistemas", mode: 0o750 },
      "/home/hamilton": { dir: true, owner: "hamilton", group: "hamilton", mode: 0o755, mtime: D2 },

      "/home/hamilton/bienvenida.txt": {
        owner: "hamilton", group: "hamilton", mtime: D2,
        content: [
          ...
          "",
          "Tu carpeta personal es /home/hamilton. Dentro tienes:",
          ...
          "",
          "Sigourney Weaver, administradora de sistemas",
          ""
        ].join("\n")
      },

      "/home/hamilton/documentos": { dir: true, owner: "hamilton", group: "hamilton", mtime: D },
      "/home/hamilton/documentos/informe-red.txt": {
      ...
      "/home/hamilton/documentos/notas.md": {
        owner: "hamilton", group: "hamilton", mtime: D,
        content: [
          "# Notas del equipo",
          "",
      ...
      "/home/hamilton/documentos/presupuesto.csv": {
        owner: "hamilton", group: "hamilton", mtime: D,
        content: [
      ...
      "/home/hamilton/registros": { dir: true, owner: "hamilton", group: "hamilton", mtime: D2 },
      "/home/hamilton/registros/acceso.log": {
        owner: "hamilton", group: "hamilton", mtime: D2,
        content: [
          "2026-09-13 07:58:02 INFO  sesion iniciada usuario=weaver origen=192.168.10.5",
          "2026-09-13 08:01:44 INFO  sesion iniciada usuario=hamilton origen=192.168.10.31",
          ...
          "2026-09-13 09:02:27 INFO  sesion cerrada usuario=weaver",
      ...
      "/home/hamilton/registros/sistema.log": {
        owner: "hamilton", group: "hamilton", mtime: D2,
        content: [
      ...
      "/home/hamilton/registros/errores.log": {
        owner: "hamilton", group: "hamilton", mtime: D2,
        content: [
      ...
      "/home/hamilton/scripts": { dir: true, owner: "hamilton", group: "hamilton", mtime: D },
      "/home/hamilton/scripts/copia.sh": {
        owner: "hamilton", group: "hamilton", mode: 0o755, mtime: D,
        content: [
          "#!/bin/bash",
          "# Copia los documentos a /mnt/copias",
          "rsync -a /home/hamilton/documentos/ /mnt/copias/documentos/",
          ""
        ].join("\n")
      },
      "/home/hamilton/scripts/limpiar.sh": {
        owner: "hamilton", group: "hamilton", mode: 0o755, mtime: D,
        content: [
          "#!/bin/bash",
      ...
      "/home/hamilton/tareas": { dir: true, owner: "hamilton", group: "hamilton", mtime: D2 },
      "/home/hamilton/tareas/pendientes.txt": {
        owner: "hamilton", group: "hamilton", mtime: D2,
        content: [
      ...
      "/srv/compartido/manual-consola.txt": {
        owner: "weaver", group: "sistemas", mtime: D,
        content: [
