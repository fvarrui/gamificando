...
(function (global) {
  ...
  PW.MISSION_CONTENT = [
    ...
    },
    {
      ...
      text: "Michelle y su equipo tienen que crear, cambiar y borrar documentos en su carpeta. Eso no es control total: es «modificar».",
    ...
    {
      phase: 2, severity: "info", source: WEAVER, xp: 125,
    ...
    {
      phase: 3, severity: "warn", source: YEOH, xp: 150,
      title: "El fichero de la compañera que se fue",
      text: "Brigitte dejó la empresa el 30 de septiembre y su borrador del plan 2027 sigue siendo suyo. Mira quién figura como propietario.",
    ...
    },
    {
      ...
      title: "Toma posesión",
      text: "Con la cuenta de Brigitte deshabilitada, nadie puede gestionar ese fichero. Para eso existe takeown: tomar posesión de algo cuyo propietario ya no está.",
