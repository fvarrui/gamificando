/* Recorrido completo de «Los intocables»: resuelve las 26 tareas
...
const t = checker();
const b = await launch(fileUrl('los-intocables/index.html'), { port: 9404 });
const g = game(b);
const check = t.check;
...
const PASOS = [
  ...
  ['ACL-07', ['sudo chown yeoh memoria.txt presupuesto.csv acta-direccion.txt']],
  ...
  ['ACL-18', ['sudo setfacl -m u:vandamme:r acta-direccion.txt']],
  ['ACL-19', ['sudo setfacl -m u:vandamme:x /srv/proyectos']],
  ['ACL-20', ['sudo setfacl -x u:lundgren memoria.txt']],
