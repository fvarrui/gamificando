...
(function (global) {
  ...
  PS.cfg = {
    ...
    TEAM: "Arnold Schwarzenegger (administrador de sistemas)",
  ...
  PS.build = function (S) {
    S.sys.load({
      ...
      users: [
        ...
        { name: "arnold", uid: 1000, group: "Usuarios", home: "C:\\Users\\arnold", comment: "Arnold Schwarzenegger" },
        { name: "hamilton", uid: 1001, group: "Usuarios", home: "C:\\Users\\hamilton", comment: "Cuenta de prácticas" }
      ],
      members: [["Administradores", "arnold"], ["Soporte", "arnold"], ["Usuarios", "hamilton"]]
    });

    S.vfs.build({
      "C:\\Users": { dir: true, owner: "Administradores" },
      "C:\\Users\\arnold": { dir: true, owner: "arnold", aces: own("arnold"), inherit: false },
      "C:\\Users\\hamilton": { dir: true, owner: "hamilton", aces: own("hamilton"), mtime: D2 },

      "C:\\Users\\hamilton\\Bienvenida.txt": {
        owner: "hamilton", mtime: D2,
        content: [
          "Bienvenida a TecnoAtlantica",
          "===========================",
          "",
          "Este equipo es el de hamilton del CPD: todo lo que hay dentro es",
          "una copia, asi que puedes trastear sin miedo.",
          "",
          "Tu carpeta personal es C:\\Users\\hamilton. Dentro tienes:",
          ...
          "",
          "Arnold Schwarzenegger, administracion de sistemas",
          ""
        ].join("\n")
      },

      "C:\\Users\\hamilton\\Documentos": { dir: true, owner: "hamilton", mtime: D },
      "C:\\Users\\hamilton\\Documentos\\Informe-Red.txt": {
      ...
      "C:\\Users\\hamilton\\Documentos\\Notas.md": {
        owner: "hamilton", mtime: D,
        content: [
          "# Notas del equipo",
          "",
      ...
      "C:\\Users\\hamilton\\Documentos\\Presupuesto.csv": {
        owner: "hamilton", mtime: D,
        content: [
      ...
      "C:\\Users\\hamilton\\Registros": { dir: true, owner: "hamilton", mtime: D2 },
      "C:\\Users\\hamilton\\Registros\\acceso.log": {
        owner: "hamilton", mtime: D2,
        content: [
          "2026-09-14 07:58:02 INFO  sesion iniciada usuario=arnold origen=192.168.10.5",
          "2026-09-14 08:01:44 INFO  sesion iniciada usuario=hamilton origen=192.168.10.31",
          ...
          "2026-09-14 09:02:27 INFO  sesion cerrada usuario=arnold",
      ...
      "C:\\Users\\hamilton\\Registros\\sistema.log": {
        owner: "hamilton", mtime: D2,
        content: [
      ...
      "C:\\Users\\hamilton\\Registros\\errores.log": {
        owner: "hamilton", mtime: D2,
        content: [
      ...
      "C:\\Users\\hamilton\\Scripts": { dir: true, owner: "hamilton", mtime: D },
      "C:\\Users\\hamilton\\Scripts\\copia.ps1": {
        owner: "hamilton", mtime: D,
        content: [
          "# Copia los documentos a la unidad de copias",
          "Copy-Item -Path C:\\Users\\hamilton\\Documentos -Destination D:\\Copias -Recurse -Force",
          ""
        ].join("\n")
      },
      "C:\\Users\\hamilton\\Scripts\\limpiar.ps1": {
        owner: "hamilton", mtime: D,
        content: [
      ...
      "C:\\Users\\hamilton\\Tareas": { dir: true, owner: "hamilton", mtime: D2 },
      "C:\\Users\\hamilton\\Tareas\\Pendientes.txt": {
        owner: "hamilton", mtime: D2,
        content: [
