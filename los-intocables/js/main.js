...
(function (global) {
  ...
  PL.S = RG.Sandbox({
    ...
    boot: [
      ...
      [400, "text", "hamilton@srv-datos · servidor de archivos · instalado el 2 de octubre por Insular Sistemas S.L."],
      [800, "text", ""],
    ...
    badgesOf: function (S, got) {
      ...
      /* Mínimo privilegio: ventas solo lee y Jean-Claude solo atraviesa */
      ...
      var darioSoloPaso = !!dir && !!dir.acl && dir.acl.some(function (e) {
        return e.kind === "user" && e.name === "vandamme" && e.perms === "x";
      });
    ...
    debriefText: function (S, got, doneCount) {
      ...
      if (got.clean && got.self) {
        t.msg = "Impecable: la carpeta pertenece al equipo, el SGID mantiene el grupo en lo que se cree, ventas lee el presupuesto sin poder tocarlo " +
          "y Jean-Claude llega al acta sin ver nada más. Y todo sin pedir una sola pista.";
      } else if (got.clean) {
